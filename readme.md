...
### 队友招募
**(PS: 目前想基于项目 做更多的古文数据抓取以及构建一个基于PC + 移动端 + App + 小程序的全生态浏览体系 ，最后的目标是做一个免费 开源的古文社区，精神则类似于维基百科类型的，终身开源免费。这是目标吧，目前仅仅有了一个简单的网页能够实现最基本的书籍目录浏览和内容查看 地址 : [guwennet.com](http://www.guwennet.com)目标有了但是我一个人的力量确实不够需要招募更多的代码贡献者， 如果感兴趣可以加我微信：fanyang95**
